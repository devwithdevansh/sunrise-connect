    ...
    <>
      ...
      <div style={S.page}>
        ...
        <div style={{
          ...
          <img src={watermarkLogoPath} alt="Watermark" style={{ width: '420px', height: 'auto', objectFit: 'contain' }} />
        </div>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={S.headerRow}>
            ...
            <div>
              <div style={S.schoolName}>SUNRISE CONVENT SCHOOL</div>
          ...
          <table style={S.metaTable}>
            <tbody>
              {metaRows.map((row, i) => (
                <tr key={i} style={{ backgroundColor: i % 2 === 0 ? 'rgba(0,0,0,0.025)' : 'transparent' }}>
          ...
          <table style={S.feeTable}>
            <thead>
              <tr>
                <th style={{ ...S.thLeft, width: '34px' }}>#</th>
                <th style={S.thLeft}>Description</th>
                <th style={{ ...S.thLeft, width: '110px' }}>Mode</th>
                <th style={{ ...S.thRight, width: '110px' }}>Amount (₹)</th>
              </tr>
            </thead>
            <tbody>
              {transaction.subItems && transaction.subItems.length > 0 ? (
                  ...
                  >
                    ...
                    <td style={S.tdDesc}>
                      ...
                      {item.concessionAmount > 0 && (
                        <span style={{ color: '#e8a020', fontSize: '9.5px', marginLeft: '8px', fontWeight: 600 }}>
                ...
                <tr style={{ backgroundColor: 'rgba(0,0,0,0.025)', borderBottom: '1px solid #e4eaf4' }}>
                  <td style={S.tdNum}>1</td>
                  <td style={S.tdDesc}>{transaction.feeType || 'Fee Collection'}</td>
                  <td style={S.tdDesc}>{modeLabel}</td>
          ...
          {transaction.remark && (
            <div style={{ ...S.wordsBox, marginTop: '-8px' }}>
          ...
          <div style={S.sigRow}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '10px', fontWeight: 700, color: '#333', marginBottom: '34px' }}>
